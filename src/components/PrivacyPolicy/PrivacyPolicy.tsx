import { StyledPrivacyPolicy, Info, List, ListItem, Title } from "./styles";
...
export const PrivacyPolicy = () => {
  return (
    <StyledPrivacyPolicy>
      ...
      <Info>
        “Komboocha Games” built the “Case Strike 2: Global Ops” app as an Ad Supported app. This
        SERVICE is provided by “Komboocha Games” at no cost and is intended for use as is.
      </Info>
      <Info>
      ...
      <Info>
        ...
        which are accessible at Case Strike 2: Global Ops unless otherwise defined in this Privacy
        Policy.
      </Info>
      <Title label="Information Collection and Use" />
      <Info>
        ...
        retained by us and used as described in this privacy policy. The app does use third-party
        services that may collect information used to identify you.
      </Info>
      <Info>Link to the privacy policy of third-party service providers used by the app</Info>
      <List>
        <ListItem>Google Play Services</ListItem>
        <ListItem>AdMob</ListItem>
        <ListItem>Google Analytics for Firebase</ListItem>
        <ListItem>Firebase Crashlytics</ListItem>
        <ListItem>Appodeal</ListItem>
      </List>
      <Title label="Log Data" />
      <Info>
      ...
      <Info>
        ...
        cookies, you may not be able to use some portions of this Service. Service Providers
      </Info>
      <Info>We may employ third-party companies and individuals due to the following reasons:</Info>
      <List>
      ...
      <Title label="Links to Other Sites" />
      <Info>
      ...
      <Title label="Children’s Privacy" />
      <Info>
      ...
      <Title label="Changes to This Privacy Policy" />
      <Info>
      ...
      <Info>This policy is effective as of 2023-10-24</Info>
      <Title label="Contact Us" />
      <Info>
        If you have any questions or suggestions about our Privacy Policy, do not hesitate to
        contact us at desolate.edge@gmail.com
      </Info>
    </StyledPrivacyPolicy>
  );
};
